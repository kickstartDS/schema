# JSON Schema to Stackbit admin config converter

This library exports a single function, `convert`, which converts one or more [JSON schemas](https://json-schema.org/) to a [Stackbit admin config]().
...
```
yarn add jsonschema2stackbit
```

## Misc

Available icons in Stackbit:
...
## Usage (TODO Fix, usage differs for Stackbit)

You can convert a schema expressed as an object literal:

```js
import { printSchema } from 'graphql'
import convert from 'jsonschema2stackbit'
