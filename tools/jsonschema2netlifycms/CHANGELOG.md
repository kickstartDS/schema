...
- fix: use collection name in netlify cms file ([@julrich](https://github.com/julrich))
...
- fix: handling of component schema layering ([@julrich](https://github.com/julrich))
