# JSON Schema to Payload CMS admin config converter

This library exports a single function, `convert`, which converts one or more [JSON schemas](https://json-schema.org/) to a [Payload CMS admin config](https://payloadcms.com/docs/fields).
